...
Route::group(['middleware' => ['ip_filter']], function() {
    ...
    Route::group(['middleware' => ['assign_guard:admin', 'jwt_auth:admin', 'safe_ips']], function() {
        ...
        Route::group(['middleware' => ['permission:admin']], function (){
            ...
            Route::get('book', 'ctl_book@index')->name('admin.book.index');
            Route::post('book/delete', 'ctl_book@delete')->name('admin.book.delete');
            Route::post('book/add_queue', 'ctl_book@add_queue')->name('admin.book.add_queue');
            Route::post('book/update_queue', 'ctl_book@update_queue')->name('admin.book.update_queue');
            Route::get('book/get_content', 'ctl_book@get_content')->name('admin.book.get_content');
            Route::get('book/get_chapter_list', 'ctl_book@get_chapter_list')->name('admin.book.get_chapter_list');
            Route::get('book/get_category_options', 'ctl_book@get_category_options')->name('admin.book.get_category_options');
            Route::get('book/get_queue_number', 'ctl_book@get_queue_number')->name('admin.book.get_queue_number');
            Route::get('book/get_source_options', 'ctl_book@get_source_options')->name('admin.book.get_source_options');
        });
    });
});
